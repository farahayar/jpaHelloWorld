...
import model.BibliothequeAdherent;
...
public class JPAUtil {
	...
	public JPAUtil(){
		emf=Persistence.createEntityManagerFactory("Tp4");
	...
	public void listeBibliothequeAdherent(){
		List<BibliothequeAdherent> list=em.createNamedQuery("BibliothequeAdherent.findAll", BibliothequeAdherent.class).getResultList();
		System.out.println("\n|  ");
		for(BibliothequeAdherent e1:list){
			System.out.println("----------------------------------------------------------------");
	...
	public void insertAdherent(){
		...
		em.persist(ad);
		BibliothequeAdherent ba=new BibliothequeAdherent(ad.getId(),b.getId(),ad,b);
